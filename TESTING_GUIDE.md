# Руководство по тестированию телефонной книги

## Новые функции (29.10.2025):

### 1. **Пагинация**
- **Функция**: Отображение записей постранично с выбором количества записей
- **Тестирование**:
  - Откройте приложение
  - Внизу таблицы должна появиться панель пагинации
  - Попробуйте изменить количество записей (10, 25, 50, 100)
  - Переключайтесь между страницами
  - Проверьте, что отображается правильная информация о записях

### 2. **Улучшенное перетаскивание (Drag & Drop)**
- **Функция**: Перетаскивание сотрудников для изменения порядка
- **Тестирование**:
  - Войдите в админ-панель (логин: admin, пароль: admin123)
  - Включите "Режим перетаскивания"
  - Перетащите сотрудника за иконку DragIndicator
  - Проверьте, что:
    - Сотрудник перемещается на новую позицию
    - Появляется уведомление об успешном обновлении
    - Изменения сохраняются после обновления страницы
    - Можно перетаскивать между страницами пагинации

### 3. **Визуальная обратная связь**
- **Функция**: Подсветка, анимации, уведомления
- **Тестирование**:
  - При перетаскивании должна быть подсветка
  - Должны появляться уведомления об успехе/ошибках
  - Курсор должен меняться на grab/grabbing
